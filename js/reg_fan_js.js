...
firebase.initializeApp(config);
	...
	function pushFans()
	{
		...
		var postRef = mydata.set({'firstName':firstName,'surname':surname,'dob':dob, 'addressLine1': addressLine1,'addressLine2':addressLine2,'addressLine3':addressLine3, 'creditCard': creditCard,'expiryDate':expiryDate,'cvn':cvn, 'photoId': photoId,'proofAddress':proofAddress, 'valid': "false"}); // adds unique key then the following child nodes
